...
class SessionDBAuth(SessionExpAuth):
    """Session authentication class with db storage & expiration support
    """
    def create_session(self, user_id: str) -> str:
        """Creates and stores id for the user"""
        session_id = supper().create_session(user_id)
    ...
    def user_id_for_session_id(self, session_id: str) -> str:
        """Retrieves the user id of the user associated with given
        session id.
        """
        try:
