...
def log_in_wrong_password(email: str, password: str) -> None:
    """Tests for logging in with wrong password"""
...
def profile_unlogged() -> None:
    """Tests retriving profile information whilsts logged out"""
...
def profile_logged(session_id: str) -> None:
    """Tests for retrieving profile info whilst logged in"""
    url = "{}/profile".format(BASE_URL)
    req_cookies = {
